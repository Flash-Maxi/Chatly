    ...
    return (
        <div ref={containerRef} className="relative mb-4">
            <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2.5 bg-bgSurface/70 border border-white/10 rounded-xl text-textMain outline-none transition-all duration-300 hover:bg-bgHover focus-visible:ring-2 focus-visible:ring-primary/40 disabled:opacity-60 cursor-pointer"
            >
                <span className="text-base" aria-hidden="true">🌐</span>
                <span className="flex-1 text-left text-[15px] font-medium truncate">{selectedLanguage}</span>
                <motion.span
                    ...
                    aria-hidden="true"
                >
                    <ChevronDown className="h-4 w-4 text-textSub" />
                </motion.span>
            </button>
